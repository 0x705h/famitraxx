...
FT_CH1_VOLUME		= FT_CH1_ENVS+<(FT_ENV_VALUE)
FT_CH2_VOLUME		= FT_CH2_ENVS+<(FT_ENV_VALUE)
FT_CH3_VOLUME		= FT_CH3_ENVS+<(FT_ENV_VALUE)
FT_CH4_VOLUME		= FT_CH4_ENVS+<(FT_ENV_VALUE)
FT_CH1_NOTE_OFF		= FT_CH1_ENVS+<(FT_ENV_VALUE)+FT_ENV_STRUCT_SIZE
FT_CH2_NOTE_OFF		= FT_CH2_ENVS+<(FT_ENV_VALUE)+FT_ENV_STRUCT_SIZE
FT_CH3_NOTE_OFF		= FT_CH3_ENVS+<(FT_ENV_VALUE)+FT_ENV_STRUCT_SIZE
FT_CH4_NOTE_OFF		= FT_CH4_ENVS+<(FT_ENV_VALUE)+FT_ENV_STRUCT_SIZE
FT_CH1_PITCH_OFF	= FT_CH1_ENVS+<(FT_ENV_VALUE)+FT_ENV_STRUCT_SIZE*2
FT_CH2_PITCH_OFF	= FT_CH2_ENVS+<(FT_ENV_VALUE)+FT_ENV_STRUCT_SIZE*2
FT_CH3_PITCH_OFF	= FT_CH3_ENVS+<(FT_ENV_VALUE)+FT_ENV_STRUCT_SIZE*2
...
FamiToneMusicStop				
	ldx #<(FT_CHANNELS)	;reset all the channels variables
	ldy #5
@setChannels
	lda #0
	sta FT_CHN_PTR_L,x
